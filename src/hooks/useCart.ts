...
import type { Guitar, cartItem }  from "../types/index"; // Importa el tipo cartItem
...
export const useCart = () => {
      ...
      function addToCart(items: Guitar){
        ...
        if(itemExists !== -1){        
            ...
            const NewItem : cartItem = {...items, quantity: 1}; // Creamos un nuevo item con la cantidad por defecto de 1 en reemplazo de items.quantity linea abajo
      ...
      // function incrementando(id: Guitar['id']){
      function incrementando(id: Guitar['id']){
        ...
        function decrementando(id: Guitar['id']){
